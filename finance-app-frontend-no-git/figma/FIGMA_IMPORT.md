...
| **Auth**      | `/auth`       | Mode toggle (Log In / Sign Up), Name (signup), Email, Password, primary CTA, “or continue with”, Google, Apple |
| **Verify Code** | `/verify-code` | Back, “Check your email”, “We sent a 6-digit code to {email}”, 6 digit inputs, “Resend Code” / “Resend in Xs” |
...
| Analytics     | Analytics       | Title, Period (Month / Quarter / Year), bar chart, pie chart, summary |
| Settings      | Settings        | Title, APPEARANCE (Dark mode + Light/Dark/System), CURRENCY, DATA (Manage Categories), ABOUT, Log out |

### Secondary

| Screen              | Route              | Key elements |
|---------------------|--------------------|-------------|
| Transaction Detail  | `/transaction/[id]`| Back, title “Transaction”, type/amount/category/note/date, Edit, Delete |
| Manage Categories   | `/categories`     | Back, “Manage Categories”, category list (icon, name, type), add/edit category form |
